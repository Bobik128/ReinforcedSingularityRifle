...
public class RSRifleEntityTypes {
    ...
    public static final RegistryObject<EntityType<BlackHoleProjectile2>> BLACK_HOLE_PROJECTILE2 =
            ENTITY_TYPES.register("black_hole_projectile2", () -> EntityType.Builder.<BlackHoleProjectile2>of(BlackHoleProjectile2::new, MobCategory.MISC)
                    .sized(0.2f, 0.2f)
